...
public class PanningWindow extends Region {
     ...
     * </p>
     *
     * @param pEditorProperties the {@link GraphEditorProperties} instance for the graph
     *                          editor
     */
     ...
     * </p>
     *
     * @param x the x position of the window relative to the top-left corner
     *          of the content
     * @param y the y position of the window relative to the top-left corner
     *          of the content
     */
