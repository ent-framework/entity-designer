...
public abstract class ConnectionSegment {
     ...
     * first intersection.
     *
     * @param intersection the intersection position to take into account when drawing
     *                     this element
     */
     ...
     * @param intersection     the intersection position to take into account when drawing
     *                         this element
     * @param lastIntersection the previous intersection position to take into account when
