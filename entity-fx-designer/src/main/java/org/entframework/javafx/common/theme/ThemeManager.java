...
package org.entframework.javafx.common.theme;
...
import org.entframework.javafx.common.event.EventBus;
import org.entframework.javafx.common.event.ThemeEvent;
import org.entframework.javafx.common.utils.JColor;
...
import static org.entframework.javafx.common.Resources.getResource;
import static org.entframework.javafx.common.event.ThemeEvent.EventType.COLOR_CHANGE;
import static org.entframework.javafx.common.event.ThemeEvent.EventType.FONT_CHANGE;
...
public final class ThemeManager {
    ...
    public void setTheme(SamplerTheme theme) {
        ...
        Resources.getPreferences().put("theme", theme.getName());
    ...
    public void setThemeByName(String name) {
        ...
        SamplerTheme samplerTheme = repository.getAll().stream().filter(theme -> StringUtils.equals(theme.getName(), name)).findFirst().orElse(null);
        if (samplerTheme != null) {
