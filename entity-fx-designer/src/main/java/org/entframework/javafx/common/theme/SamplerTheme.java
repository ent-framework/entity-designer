...
import org.entframework.javafx.DesignerApplication;
import org.entframework.javafx.common.FileResource;
...
import static org.entframework.javafx.DesignerApplication.IS_DEV_MODE;
import static org.entframework.javafx.common.Resources.resolve;
...
public final class SamplerTheme implements Theme {
    ...
    public String getUserAgentStylesheet() {
        return IS_DEV_MODE ? ThemeManager.DUMMY_STYLESHEET : getResource().toURI().toString();
    }
    ...
    public Set<String> getAllStylesheets() {
        return IS_DEV_MODE ? merge(getResource().toURI().toString(), ThemeManager.APP_STYLESHEETS) : Set.of(ThemeManager.APP_STYLESHEETS);
    }
    ...
    public FileResource getResource() {
        ...
        try {
            FileResource testTheme = FileResource.createInternal(
                    resolve("theme-test/" + filename), DesignerApplication.class
            );
            if (!testTheme.exists()) {
