...
public final class Resources {
    ...
    public static InputStream getResourceAsStream(String resource) {
        ...
        return Objects.requireNonNull(
                DesignerApplication.class.getResourceAsStream(resolve(path)),
    ...
    public static URI getResource(String resource) {
        String path = resolve(resource);
        URL url = Objects.requireNonNull(DesignerApplication.class.getResource(resolve(path)), "Resource not found: " + path);
