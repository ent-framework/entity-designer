...
import org.entframework.javafx.databrowser.session.parser.kernel.completions.ErrorListener;
import org.entframework.javafx.databrowser.session.parser.kernel.completions.SQLSelectStatementListener;
...
public final class ParserThread extends Thread {
    ...
    private static final I18n s_stringMgr = new I18n(ParserThread.class);
            ...
            if (listener != null) {
                switch (n) {
                    case ParsingConstants.KW_MINUS:
                        ...
                        StoreError(n, line, col, s_stringMgr.t("parserthread.undefinedTable"));
                        break;
                    default:
